...
class Acronymer
  WORDS = ["Aizoon", "Boone", "Demophoon", "Dioon", "Diplozoon", "Gaboon", "Gadswoons", "Joon", "Kokoona", "Leucocytozoon", "Roosevelt", "Rooseveltian", "Toona", "Walloon", "aboon", "actinozoon", "afternoon", "afternoons", "akhoond", "aloose",
  ...
  def acronymer word
    letters = word.chars
    acronym = letters.map {|l| @dictionary[l].sample }.join(" ")
  end
end

a = Acronymer.new
puts a.acronymer "bug"
